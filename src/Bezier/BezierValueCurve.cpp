...
namespace Grain {
    ...
    */
    ...
    BezierValueCurvePoint* BezierValueCurve::addPoint(double x, double y, double lx, double ly, double rx, double ry, Bezier::PointType point_type, BezierValueCurvePoint::Status status) noexcept {
