...
void Color::xyz_to_rgb(const float* xyz, const Mat3f& matrix, float* out_rgb) noexcept {
    ...
    out_rgb[0] = matrix.data_[0][0] * xyz[0] + matrix.data_[0][1] * xyz[1] + matrix.data_[0][2] * xyz[2];
    out_rgb[1] = matrix.data_[1][0] * xyz[0] + matrix.data_[1][1] * xyz[1] + matrix.data_[1][2] * xyz[2];
    out_rgb[2] = matrix.data_[2][0] * xyz[0] + matrix.data_[2][1] * xyz[1] + matrix.data_[2][2] * xyz[2];
}
