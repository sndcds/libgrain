...
//  AppleCGContext.hpp
//
//  Created by Roald Christesen on 24.08.2025
...
namespace Grain {
    ...
    public:
        ...
        void clipRect(const Rectd& rect) noexcept override;
        void clipRoundRect(const Rectd& rect, double radius) noexcept override;
        void clipEllipse(const Rectd& rect) noexcept override;
