...
namespace Grain {
    ...
    public:
        ...
        friend std::ostream& operator << (std::ostream& os, const Bezier& o) {
            os << o.m_pos[0].m_x << ", " << o.m_pos[0].m_y << " .. ";
            os << o.m_pos[1].m_x << ", " << o.m_pos[1].m_y << " .. ";
            os << o.m_pos[2].m_x << ", " << o.m_pos[2].m_y << " .. ";
            os << o.m_pos[3].m_x << ", " << o.m_pos[3].m_y;
            return os;
        }

        [[nodiscard]] Rectd bounds() const noexcept;
        [[nodiscard]] Vec2d startPos() const noexcept { return m_pos[0]; }
        [[nodiscard]] Vec2d controlPos1() const noexcept { return m_pos[1]; }
        [[nodiscard]] Vec2d controlPos2() const noexcept { return m_pos[2]; }
        [[nodiscard]] Vec2d endPos() const noexcept { return m_pos[3]; }
        ...
        [[nodiscard]] Vec2d tangent1() const noexcept { return (m_pos[1] - m_pos[0]); }
        [[nodiscard]] Vec2d tangent2() const noexcept { return (m_pos[2] - m_pos[3]); }
