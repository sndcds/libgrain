...
namespace Grain {
    ...
    public:
        ...
        explicit Quadrilateral(const Bounds2d& bounds) noexcept { setByRangeRect(bounds); }
        ...
        [[nodiscard]] Bounds2d axisAlignedBbox() const noexcept {
            Bounds2d bbox;
        ...
        void setByRangeRect(const Bounds2d& bounds) noexcept {
            points_[0].x_ = bounds.min_x_; points_[0].y_ = bounds.min_y_;
            points_[1].x_ = bounds.max_x_; points_[1].y_ = bounds.min_y_;
            points_[2].x_ = bounds.max_x_; points_[2].y_ = bounds.max_y_;
            points_[3].x_ = bounds.min_x_; points_[3].y_ = bounds.max_y_;
            valid_points_ = true;
            solvePerspective();
        }
